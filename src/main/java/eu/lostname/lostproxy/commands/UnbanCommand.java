...
public class UnbanCommand extends Command implements TabExecutor {
    ...
    public void execute(CommandSender commandSender, String[] strings) {
        if (strings.length <= 1) {
            ...
            commandSender.sendMessage(new MessageBuilder("§8" + Prefix.DASH + " §c/unban §l<Spieler> [Grund] §8» §7Entbannt einen gebannten Spieler").addClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/unban ").build());
