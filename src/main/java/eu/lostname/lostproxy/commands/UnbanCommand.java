...
public class UnbanCommand extends Command implements TabExecutor {
    ...
    public void execute(CommandSender commandSender, String[] strings) {
        if (strings.length <= 1) {
            ...
            commandSender.sendMessage(new MessageBuilder("§8» §c/unban <Spieler> [Grund] §8" + Prefix.DASH + " §7Entbannt einen gebannten Spieler").addClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/unban ").build());
