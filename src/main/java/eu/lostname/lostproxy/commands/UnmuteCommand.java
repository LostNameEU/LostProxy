        ...
        if (strings.length <= 1) {
            ...
            if (uuid != null) {
                ...
                if (iMute != null) {
                    ...
                    LostProxy.getInstance().getTeamManager().sendUnmuteNotify(commandSender instanceof ProxiedPlayer ? new IPlayerSync(((ProxiedPlayer) commandSender).getUniqueId()).getPrefix() + commandSender.getName() : "§4Konsole", targetIPlayer.getPrefix() + targetIPlayer.getPlayerName(), reason);
                } else {
