...
public class UnmuteCommand extends Command implements TabExecutor {
    ...
    public void execute(CommandSender commandSender, String[] strings) {
        if (strings.length <= 1) {
            ...
            commandSender.sendMessage(new MessageBuilder("§8┃ §c/unmute §l<Spieler> [Grund] §8» §7Entmutet einen gemuteten Spieler").addClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/unmute ").build());
