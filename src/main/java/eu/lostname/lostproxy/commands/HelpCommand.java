...
public class HelpCommand extends Command {
    ...
    public void execute(CommandSender commandSender, String[] strings) {
        ...
        commandSender.sendMessage(new MessageBuilder("§8" + Prefix.DASH + " §c/hub §8» §7Bringt dich auf die Hauptlobby zurück").build());
        commandSender.sendMessage(new MessageBuilder("§8" + Prefix.DASH + " §c/friend §8» §7Verwalte deine Freunde").build());
        commandSender.sendMessage(new MessageBuilder("§8" + Prefix.DASH + " §c/party §8» §7Erstelle eine Party").build());
        commandSender.sendMessage(new MessageBuilder("§8" + Prefix.DASH + " §c/clan §8» §7Verwalte deinen Clan").build());
        commandSender.sendMessage(new MessageBuilder("§8" + Prefix.DASH + " §c/report §8» §7Melde einen regelbrechenden Spieler").build());
