...
public class HelpCommand extends Command {
    ...
    public void execute(CommandSender commandSender, String[] strings) {
        ...
        commandSender.sendMessage(new MessageBuilder("§8» §c/hub §8" + Prefix.DASH + " §7Bringt dich auf die Hauptlobby zurück").build());
        commandSender.sendMessage(new MessageBuilder("§8» §c/friend §8" + Prefix.DASH + " §7Verwalte deine Freunde").build());
        commandSender.sendMessage(new MessageBuilder("§8» §c/party §8" + Prefix.DASH + " §7Erstelle eine Party").build());
        commandSender.sendMessage(new MessageBuilder("§8» §c/clan §8" + Prefix.DASH + " §7Verwalte deinen Clan").build());
        commandSender.sendMessage(new MessageBuilder("§8» §c/report §8" + Prefix.DASH + " §7Melde einen regelbrechenden Spieler").build());
