                ...
                if (!player.hasPermission("lostproxy.bkms.bypasschat")) {
                    ...
                    if (iMute != null) {
                        ...
                        if (iMute.getDuration() == -1) {
                            ...
                            iMuteHistory.addEntry(new IMuteEntry(EMuteEntryType.UNMUTE_ENTRY, player.getUniqueId(), "console", System.currentTimeMillis(), "MUTE_EXPIRED_ON_MSG_SEND", 0, 0));
                            ...
                            LostProxy.getInstance().getTeamManager().getNotificationOn().forEach(all -> {
                                ...
                                all.sendMessage(new MessageBuilder("§8┃ §7Grund §8» §eAbgelaufen beim Nachrichtenversand").build());
